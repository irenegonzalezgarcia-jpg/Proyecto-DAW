...
function mostrarMensajeExito(){
  // Creamos el bloque de éxito de forma dinámica siguiendo tu metodología
  ...
  // CAMBIO CLAVE: Lo metemos dentro del propio formulario (<form>), justo debajo del botón
  formContacto.append(divExito);
}
...
formContacto.addEventListener("submit", (e)=>{
  ...
  // Validación de formato de email con tu Regex
  ...
  // Estructura del objeto siguiendo el estilo de tus cuentas bancarias
  const nuevoMensaje = {
